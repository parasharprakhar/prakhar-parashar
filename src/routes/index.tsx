              ...
              <table className="w-full table-fixed border-collapse text-left">
                ...
                <thead>
                  <tr className="border-b border-hairline bg-surface/60">
                    <th scope="col" className="label w-[26%] p-3 font-normal">
                      Metric
                    </th>
                    <th scope="col" className="label hidden w-[44%] p-3 font-normal sm:table-cell">
                      Context
                    </th>
                    <th scope="col" className="label w-[30%] p-3 text-right font-normal">
                      Reading
                    </th>
                  </tr>
                </thead>
